...
public class BubbleFrame extends JFrame{
   ...
   private void initService() { //backgorundservice는 player에 의존하기 때문
	   new Thread(new BackgroundMapSevice(player)).start();
   }
   
   // 모든 new 
   private void initObject() {
      backgroundmMap = new JLabel();
      backgroundmMap.setIcon(new ImageIcon("image/test.png"));
