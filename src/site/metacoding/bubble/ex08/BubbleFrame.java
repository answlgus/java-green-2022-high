...
//main을 가진 클래스는 해당 프로그램의 컨텍스트(문맥)를 모두 알고 있다 -> 모두 main에서 실행되기 때문에
//main을 가진 클래스 = context
public class BubbleFrame extends JFrame {
	
	private BubbleFrame context = this; // this -> BubbleContext의 메모리 공간을 가리킴 
	...
	private void initListener() {
		addKeyListener(new KeyListener() {
			...
			public void keyPressed(KeyEvent e) {
				...
				} else if(e.getKeyCode() == KeyEvent.VK_SPACE) { //attack은 player의 책임
